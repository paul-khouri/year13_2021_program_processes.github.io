...
updateContext({s:"rgb(255,255,255)"})
function draw_grid(){
...
draw_grid();
drawCircle(width/2, height/2,80,true, true, {f:"rgb(200,45,0)", s:"rgb(200,255,255)", l: 5})
text_box(50,50,200,50, "rgb(0,40,255)", "rgb(255,255,255)", "Hiya")