class Button{
   ...
   class UndoPic{
       ...
       draw(){
        //drawRectangle x, y, width, height fill(boolean), stroke(boolean), 
        //fill colour, stroke colour, stroke width
        this.drawRectangle(this.x, this.y, this.w, this.w, true, true, this.fc, this.sc, this.sw);

       }
   }
   UndoPic.prototype.drawRectangle=drawRectangle;

   class AnimateCircle{
    //class AnimateCircle x, y, r, boolean for fill, boolean for stroke, rgba string for fill , rgba string for stroke, strokewidth
        constructor(x,y, w, f, s, fc, sc, sw){
            this.x = x;
            this.y = y;
            this.w = w;
            this.r = w/3;
        ...
        draw(){
        this.drawRectangle(this.x, this.y, 3*this.r, 3*this.r, false, true, "", "rgb(255,0,0)", 1 );
          ...
          var currentRadius= R*this.r
            ...
            this.drawCircle(this.x+2*this.r,this.y+this.r,currentRadius, this.f, this.s);
            this.drawCircle(this.x+this.r,this.y+2*this.r,currentRadius, this.f, this.s);
           
            this.drawCircle(this.x+2*this.r,this.y +2*this.r,currentRadius, this.f, this.s);
