...
class MoveRectangle{
    constructor(name,x,y,w,h, Point, canvas, colourA){
        ...
        this.P_1 = new Point(x,y, this.pRad, colArray[0][6], colArray[0][7], colArray[0][5], canvas);
        this.P_2 = new Point(x+w,y+h, this.pRad, colArray[0][6], colArray[0][7], colArray[0][5], canvas);
        this.controlP = new Point(x+w/2,y+h/2, this.pRad, colArray[0][6], colArray[0][7], colArray[0][5], canvas);
