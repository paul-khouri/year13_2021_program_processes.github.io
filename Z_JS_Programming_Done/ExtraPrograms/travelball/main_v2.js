...
var ballOne = new Ball(2*width/10, 5*height/10 - 50, 10, colArray[0][0], 1, 40*Math.PI/180);
...
var bounceOne = new BounceCircle(1*width/10, height/2, 50, colArray[0][1]);
var bounceTwo = new BounceCircle(3*width/10, height/2, 50, colArray[0][1]);
