...
drawDiagram(xC, yC, xCircle, yCircle,rC, angle, reflectAngle, i){
        ...
        this.drawLine(xC,yC,xCircle,yCircle,0.5);
        ...
        // tangent line
        this.drawLine(xR+ rC*Math.cos(perpAng), yR + rC*Math.sin(perpAng), xR- rC*Math.cos(perpAng), yR - rC*Math.sin(perpAng),0.5 );
        // vector of ball[0] drawn at tangent line
        this.drawLine(xR, yR, xR - rC*Math.cos(this.ball[i].getTravelAngle()), yR - rC*Math.sin(this.ball[i].getTravelAngle()),0.5 );
       
        this.drawLine(xR, yR, xR +rC*Math.cos(reflectAngle), yR + rC*Math.sin(reflectAngle), 0.5 );
