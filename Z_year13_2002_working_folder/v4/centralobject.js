    ...
    mUp(e) {
        ...
        if(this.okayForDraw) {
            if (chosenShape.text === "Rectangle") {
                ...
                let temp = new Polygon(this.x_s, this.y_s, this.x_f, this.y_f, chosenColour, chosenShape.value)
                this.objectSet.push(temp)
            }
            else if (chosenShape.text === "Star") {
                let temp = new Star(this.x_s, this.y_s, this.x_f, this.y_f, chosenColour, chosenShape.value)
                this.objectSet.push(temp)
            }
